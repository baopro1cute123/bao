...
const ChartComponent = () => {
  ...
  return (
    <div className="sin-chart-container">
      ...
      <LineChart width={650} height={300} data={data} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
        <CartesianGrid strokeDasharray="3 3" />
        <XAxis dataKey="angle" label={{ value: 'Angle (degrees)', position: 'insideBottom', offset: -5, fill: '#666' }} />
